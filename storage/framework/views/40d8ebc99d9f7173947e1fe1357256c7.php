...
<?php $component->withAttributes([]); ?>
             ...
             <?php $__env->slot('description', null, []); ?> 
                Manage all sections and content that appear on your About page
             <?php $__env->endSlot(); ?>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->getSections(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <!--[if BLOCK]><![endif]--><?php if($section['status'] === 'configured'): ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\bakeryshop front update-back\resources\views/filament/pages/about-page.blade.php ENDPATH**/ ?>