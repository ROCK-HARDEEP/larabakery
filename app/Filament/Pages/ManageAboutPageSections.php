...
class ManageAboutPageSections extends Page implements HasForms, HasTable
{
    ...
    protected static string $view = 'filament.pages.manage-about-page-sections';
    ...
    {
        return $table
            ->query(CustomSection::query()->where('page', 'about'))
            ->columns([
    ...
    {
        return [
            'before_intro' => 'Before Introduction',
            'after_intro' => 'After Introduction',
            'before_mission' => 'Before Our Mission',
            'after_mission' => 'After Our Mission',
            'before_values' => 'Before Our Values',
            'after_values' => 'After Our Values',
            'before_team' => 'Before Our Team',
            'after_team' => 'After Our Team',
